...
#' 
## ----RStudio1, echo = FALSE, out.width = my.out.width, fig.cap = 'The RStudio screen'----
...
#' 
## ----RStudio2, echo = FALSE, out.width = my.out.width, fig.cap = 'Explaining the RStudio screen'----
...
#' 
## ----example-script, echo = FALSE, out.width = my.out.width, fig.cap = 'Example of a R script'----
...
#' 
## ----example-script-source, echo = FALSE, out.width = my.out.width, fig.cap = 'Example of a R script after execution'----
knitr::include_graphics('figs/RStudio_example_script_source.png')
...
#' 
#' The use of `class` command confirms this result
#' 
## ------------------------------------------------------------------------
# print class of x
class(x)
...
#' 
#' It is noteworthy to point out that typing the o
#' 
...
#' 
#' As noted earlier, each object has its own prope
#' 
#' 
...
#' 
#' In a future chapter, we will take more time exp
#' 
#' 
...
#' 
#' To show the current working directory, simply u
#' 
## ----tidy=TRUE-----------------------------------------------------------
# get current dir 
my.dir <- getwd()
...
#' 
#' Therefore, after copying the address, modify al
#' 
## ----eval=FALSE----------------------------------------------------------
...
x <- 'abc' # this is a inline comment 

#' 
#' Comments are a way to communicate with the user
#' 
## ---- eval=FALSE---------------------------------------------------------
## # read csv file
...
#' 
#' R packages can be accessed and installed from d
#' 
...
#' 
#' * [pmfdR](https://CRAN.R-project.org/package=pm
#' 
#' The CRAN is the official repository of R and it
#' 
...
#' 
## ----RStudio-update, curl=FALSE, echo=FALSE, out.width = '100%', fig.cap = 'Updating R packages'----
...
#' 
#' A very useful feature of Studio is _code comple
#' 
#' 
...
#' 
## ----autocomplete-files, echo=FALSE, out.width = '100%', fig.cap = 'Usage of autocomplete for files and folder'----
...
#' 
#' 
#' ## Interacting with files and operating system
#' 
...
#' 
#' To list files from your computer, simply use th
#' 
## ------------------------------------------------------------------------
