...
#' 
#' As you can see, all values were converted to `c
#' 
## ------------------------------------------------------------------------
...
#' 
#' For an inequality test, use symbol `!`, as show
#' 
## ------------------------------------------------------------------------
...
#' 
#' For both date objects, the date/time format is 
#' 
## ------------------------------------------------------------------------
...
#' 
#' 
#' ### Other function for manipulating dates and t
#' 
...
#' ### Defining `NA` values
#' 
#' To define omissions in the dataset, just use th
#' 
## ------------------------------------------------------------------------
# a vector with NA
my.x <- c(1,2,NA, 4, 5)
