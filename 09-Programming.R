...
#' 
#' 
#' In chapters \@ref(BasicObjects), \@ref(DataStru
#' 
#' 
#' ## Creating Functions
#' 
#' As emphasized in an earlier chapter, **the use 
#' 
#' A function can be further developed, so its app
#' 
...
#' 
#' After executing the function definition in the 
#' 
## ------------------------------------------------------------------------
...
#' 
#' The problem with the `NA` is this object is con
#' 
#' To handle `NA` values in function `my.fct`, a p
#' 
## ---- tidy=FALSE---------------------------------------------------------
my.fct <- function(x = c(1,1,1,1)){
  # Calculates the average of input x
...
#' 
#' Let's create a function that takes as input a `
#' 
...
#' 
#' Now, let’s write a function that, using a `data
#' 
#' 
## ---- tidy = FALSE-------------------------------------------------------
...
#' 
#' The great thing about _loops_ is the length of 
#' 
...
#' 
#' While the previous code would do what we need, 
#' 
#' 
## ------------------------------------------------------------------------
# set vec
...
#' 
#' All procedures using _loops_ can be restructure
#' 
#' 
#' ### Using `lapply`
#' 
...
#' 
#' Using `lapply` is useful when utilizing a custo
#' 
## ---- tidy=FALSE---------------------------------------------------------
...
#' 
#' Now, we use function `create.rnd.file` with `la
#' 
## ------------------------------------------------------------------------
# set options
n.files <- 5
...
#' 
#' Using a descriptive table is helpful to underst
#' 
#' 
#' ### Using `tapply`
#' 
...
#' 
#' Going back to the example, we can see the resul
#' 
#' 
#' ### Using `mapply`
#' 
...
#' 
#' Function `my.fct` needed to be created for usin
#' 
#' 
#' ## Data Manipulation with Package `dplyr`
#' 
#' One of the most important assets of an experien
#' 
...
#' 
#' To select columns, you can use function `select
#' 
## ---- tidy=FALSE---------------------------------------------------------
library(dplyr)
...
#' 
#' This possibility is interesting when dealing wi
#' 
...
#' 
#' Using `dplyr` functions for `dataframe` manipul
#' 
#' 
...
#' 
#' In the code, we use symbol ` %>%` in the end of
#' 
#' 
